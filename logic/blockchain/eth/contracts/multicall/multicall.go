...
func (_Multicall *MulticallCaller) Aggregate(opts *bind.CallOpts, calls []MulticallCall) (struct {
	BlockNumber *big.Int
	ReturnData  [][]byte
}, error) {
	var out []interface{}
...
//
// Solidity: function aggregate((address,bytes)[] calls) view returns(uint256 blockNumber, bytes[] returnData)
func (_Multicall *MulticallSession) Aggregate(calls []MulticallCall) (struct {
	BlockNumber *big.Int
	ReturnData  [][]byte
}, error) {
...
//
// Solidity: function aggregate((address,bytes)[] calls) view returns(uint256 blockNumber, bytes[] returnData)
func (_Multicall *MulticallCallerSession) Aggregate(calls []MulticallCall) (struct {
	BlockNumber *big.Int
	ReturnData  [][]byte
}, error) {
	return _Multicall.Contract.Aggregate(&_Multicall.CallOpts, calls)
